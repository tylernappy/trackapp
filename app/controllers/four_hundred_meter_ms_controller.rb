class FourHundredMeterMsController < ApplicationController
  def edit
    find_season
    find_meet
    @four_hundred_meter_m = @meet.four_hundred_meter_ms.find(params[:id])
  ...
  def update
    ...
    find_meet
    @four_hundred_meter_m = @meet.four_hundred_meter_ms.find(params[:id])
    if @four_hundred_meter_m.update_attributes(four_hundred_meter_m_permit)
